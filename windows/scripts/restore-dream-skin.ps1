  ...
  try {
    ...
    if ($Uninstall) {
      ...
      @(
        ...
        (Join-Path $desktop 'Codex 启动器（原生或皮肤）.lnk'),
        (Join-Path $desktop '皮肤启动器（Codex 或 MiMo）.lnk'),
        (Join-Path $desktop '皮肤启动器.lnk'),
        (Join-Path $desktop 'Skin Launcher.lnk'),
        (Join-Path $desktop 'MiMo 皮肤启动器.lnk'),
        (Join-Path $desktop 'Start-Dream-Skin.ps1 - 快捷方式.lnk'),
        ...
        (Join-Path $startMenu 'Codex 启动器（原生或皮肤）.lnk'),
        (Join-Path $startMenu '皮肤启动器（Codex 或 MiMo）.lnk'),
        (Join-Path $startMenu '皮肤启动器.lnk'),
        (Join-Path $startMenu 'Skin Launcher.lnk'),
